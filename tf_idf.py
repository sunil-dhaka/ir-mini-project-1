...
#===============================
def tf_idf_system(query_file,test_corpora_dir,inverted_index_json_file='inverted-index-data.json',index_json_file='index-data.json',output_file_path='qrels-tfidf.txt',top_k=5,pre_process=False):
...
if __name__=='__main__':
    ...
    tic=time()
    relevent_files=tf_idf_system(query_input,data_dir_name)
    toc=time()
